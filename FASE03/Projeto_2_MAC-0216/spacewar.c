...
void CriaDisparo(WINDOW* w1,Bullet* Bs, Nave* Ns, int i,int nb){
...
int Update(Bullet* Bs, Nave* Ns, Planet P, int nb, double dt, double t, double tb,int* dispclk, WINDOW *w1){
    /* recebe
    ...
    */
    ...
    case 2:
        ...
        break;
    case 3:
        if(dispclk[0]==0)CriaDisparo(w1,Bs,Ns,0,nb);
        dispclk[0]=1;
        break;
    case 4:
    ...
    case 6:
        ...
        break;
    case 7:
        if(dispclk[1]==0)CriaDisparo(w1,Bs,Ns,1,nb);
        dispclk[1]=1;
        break;
    case 8:
    ...
    col=CheckCollision(Ns[0]->c,Ns[1]->c,0,0);
    return col;
}
...
void Simulate(Bullet* Bs, Nave* Ns, Planet P, int nb, double dt, double tf, double tb,double bounds[],WINDOW* w1,PIC Pbkg,PIC Pplnt, PIC Pf){
    ...
    */
    ...
    for(t = 0; t < tf; t += dt){
        ...
        col=Update(Bs, Ns, P, nb, dt, t, tb,dispclk, w1);                       /*atualiza valor das posições dos objetos*/
